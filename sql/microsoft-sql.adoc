...
|
|sysadmin | users with this role can do ANYTHING they want
|
|serveradmin | These can only change configurations and shut down a server
|
|securityadmin | Manage logins and properties. They can also reset passwords
|
|processadmin | End processes that are runnin in an instance of SQL Server
|
...
|
|public | Every SQL Server login becomes a member of `public`. All objects that are public will be accesible
|===
